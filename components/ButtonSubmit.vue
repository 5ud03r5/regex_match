<template>
    <button title='save' class=""><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor"
            class="bi bi-save2-fill hover:text-gray-700 text-gray-900" viewBox="0 0 16 16">
            <path
