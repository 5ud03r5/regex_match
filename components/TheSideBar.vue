<template>
    <div class="h-max p-2 rounded-lg shadow-xl fixed bg-gay-800 w-[62px] flex flex-col space-y-2 bg-gray-800">


        <NuxtLink to='/' title="regex"
            class="bg-gray-300 p-2 rounded-md hover:shadow-lg hover:cursor-pointer hover:bg-gray-400">
        ...
        <NuxtLink to='/guides' title="guides"
            class="bg-gray-300 p-2 rounded-md hover:shadow-lg hover:cursor-pointer hover:bg-gray-400"><svg
