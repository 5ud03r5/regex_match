<template>
    <div v-if="user" class="flex justify-center flex-col space-y-5">
        <div class="flex space-x-4"><input spellcheck='false' v-model="input" placeholder="Enter regex..."
                class="shadow-xl hover:outline-none rounded-xl p-2 focus:outline-none w-[1000px]" />

        </div>
        <div>
            <textarea v-model="text" spellcheck="false" placeholder="Enter text to parse..."
                class=" shadow-xl hover:outline-none rounded-xl focus:outline-none w-[1000px] resize-none p-2 h-[400px]"></textarea>
        </div>
